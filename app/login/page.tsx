...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      setSuccess("Login successful. You can connect this to real auth next.");
    }, 900);
  };
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="mx-auto max-w-xl rounded-[2rem] border border-[#e7ddd1] bg-white/80 p-8 shadow-[0_12px_34px_rgba(0,0,0,0.05)] md:p-10">
          ...
          <p className="mt-4 text-[1rem] leading-8 text-[#655d56]">
            Access your account to save watches, manage inquiries, and follow
            your favorites.
          </p>
          ...
          <div className="mt-6 flex flex-col gap-3 text-sm text-[#655d56] sm:flex-row sm:items-center sm:justify-between">
            ...
            <p>
              No account yet?{" "}
              <Link href="/register" className="font-medium text-[#2f2925]">
                Create one
              </Link>
            </p>
          </div>
